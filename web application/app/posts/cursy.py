...
def index():
	...
	if onDate != None:
		...
		def curses():
			...
			usd = ('http://www.nbrb.by/API/ExRates/Rates/145?onDate={}&Periodicity=0'.format(onDate))
			...
			eur = ('http://www.nbrb.by/API/ExRates/Rates/292?onDate={}&Periodicity=0'.format(onDate))
			...
			rub = ('http://www.nbrb.by/API/ExRates/Rates/298?onDate={}&Periodicity=0'.format(onDate))
			...
			uah = ('http://www.nbrb.by/API/ExRates/Rates/290?onDate={}&Periodicity=0'.format(onDate))
			...
			pln = ('http://www.nbrb.by/API/ExRates/Rates/293?onDate={}&Periodicity=0'.format(onDate))
		...
		return render_template('curs.html', cursy = curses())	
	else:
		...
		return render_template('curs.html', cursy = cursy())
